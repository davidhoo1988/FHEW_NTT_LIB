...
sigma = 3.19 # set up the stdev of the Gaussian distribution
offset = ceil(sigma*8) # set up the domain of the Gaussain dist. to [-offset,...,0,...,offset]
print ( "range[-{offset},...,{offset}]".format(offset = offset) )
S = 0
