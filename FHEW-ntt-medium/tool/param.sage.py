...
_sage_const_32 = Integer(32); _sage_const_100000 = Integer(100000); _sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_4 = Integer(4); _sage_const_0 = Integer(0); _sage_const_6 = Integer(6); _sage_const_255 = Integer(255); _sage_const_256 = Integer(256); _sage_const_1p4 = RealNumber('1.4')# Find the bigger modulus Q s.t. q = 1 mod 2N
N = _sage_const_32 
Qbit = _sage_const_32 
