...
_sage_const_256 = Integer(256); _sage_const_2 = Integer(2); _sage_const_27 = Integer(27); _sage_const_1p4 = RealNumber('1.4'); _sage_const_512 = Integer(512); _sage_const_1024 = Integer(1024); _sage_const_7 = Integer(7); _sage_const_1p0 = RealNumber('1.0'); _sage_const_8 = Integer(8); _sage_const_1 = Integer(1); _sage_const_23 = Integer(23); _sage_const_25 = Integer(25); _sage_const_12 = Integer(12); _sage_const_9p5019 = RealNumber('9.5019')# FHEW system parameters
# LWE parameters
n = _sage_const_256 
